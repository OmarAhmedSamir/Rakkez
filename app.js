...
(function initRakkeZResetSystem() {
    ...
    function bindFallbackEvents(overlay) {

        const close =
            getElement("rakkezResetClose");

        const current =
            getElement("rakkezResetCurrent");

        const full =
            getElement("rakkezResetFull");
    ...
    /* =====================================================
       BIND MAIN RESET BUTTON
       ===================================================== */

    function bindMainResetButton() {
