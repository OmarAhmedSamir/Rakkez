...
(function(){
    ...
    const LANGUAGE_KEY = "rakkez_language";
    ...
    const RAKKEZ_TRANSLATIONS = {
        ...
        ar: {
            ...
            timerMessage:
                "حافظ على تركيزك. شيء واحد في كل مرة.",
    ...
    function applyRakkeZLanguage(){
        ...
        */
        ...
        const focusOnlyButton =
            get("focusOnlyBtn");

        if(focusOnlyButton){

            focusOnlyButton.title =
                RAKKEZ_TRANSLATIONS[
                    currentLanguage
                ].focusOnly;
