...
/* =========================================================
   ...
   ---------------------------------------------------------
   Restart ONLY the current Focus / Break.
...
/* =========================================================
   ...
   Everything starts from ZERO again.
   ========================================================= */

function resetFullSession() {

    console.log("RakkeZ: FULL RESET");
    ...
    localStorage.removeItem("rakkez_last_focus_day");


    /* =====================================================
       RESET TASK FOCUS TIME
       -----------------------------------------------------
       Only reset the focus-time statistics attached to
       tasks. Keep the tasks themselves.
       ===================================================== */
    ...
    /* =====================================================
       RESET TIMER TO ORIGINAL FOCUS START
       ===================================================== */
    ...
    console.log("RakkeZ: Full reset completed.");
}
